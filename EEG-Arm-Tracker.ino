...
#define SAMPLERATE   100                // Frecventa de esantionare semnal / canal
#define READINGS     40                 // Interval pt calculul mediei semnalului   
...
#define XTH_LIMIT_PLUS 100               // Limitele de variatie a pragurilor
#define XTH_LIMIT_MINUS 100
#define YTH_LIMIT_PLUS 100
#define YTH_LIMIT_MINUS 100
...
void setup() {
  ...
  Serial.begin(9600);
  /*delay(100);                         //Pentru ca da
  Serial.println("Plz w8 10 sec...");*/
  delay(10000);                       //Preventiv
  Serial.println("Ok, gud 2 go !");
  Keyboard.begin();
